...
# echo " 1000 0.3640    2.02   2.8743  0.4 10.0  0.3640 " >> fort.5 # N2; LK
#
#==========================
 else if ($mgo == 2) then
...
#          amA        amB        amu
  echo " 14.0        14.0       7.00153720 " >> fort.5
#--------------------------
#       Vibrational & rotational constants : 
#            Her(Herzberg; 1979); LK(Lofthus & Krupenie; 1977)
#       We             WeXe         WeYe         WeZe   
#echo " 1.0746436D-02  6.52649D-05 -1.02977D-08 -1.09352D-09 " >> fort.5 #(Her)
 echo " 1.0746429D-02  6.52668D-05 -1.02882D-08 -1.07074D-09 " >> fort.5 #(LK)
#-
#          WeTe          WeSe          WeRe   
 echo "    0.0           0.0           0.0   " >> fort.5
#---
#           be           alphae        gamae
# echo " 9.104651D-06    7.890661D-08  0.0   " >> fort.5  # (Her)
  echo " 9.104455D-06    7.872892D-08  0.0   " >> fort.5  # (LK)
#-
#          Der           betae
  echo "   0.0           0.0   " >> fort.5  # 
 endif 
...
#            wexe           be              ae    
# echo "  6.5267D-05      9.104651D-06     7.8729D-08  " >> fort.5
  echo "  6.52668D-05     9.104455D-06     7.872892D-08  " >> fort.5  #(LK)
 endif
#--------------------------
#
