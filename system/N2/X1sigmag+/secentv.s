...
#  set kfre = 1    # calculate free wave
   ...
   set vsf = 15    # = v'+ 1, v'is the quantum # of  FINAL  state

   set  vn = 15    #  vn = $vsf - $vsi + 1
...
#         rmin    rmax    rstep    rmatch  
 echo "   1.00    5.00    0.004    2.020  " >> fort.5
...
#echo " $nvp 30  90   $vsi $vsf $nci $ncf " >> fort.5   # 
 echo " $nvp 50  90   $vsi $vsf $nci $ncf " >> fort.5   # 
...
#    echo " $nv1  0.3640D+00     2.5885D+00      " >> fort.5 # For ktyp=4 (N2; S)
...
#         WE          WEXE        WEYE      WEZE
#  echo " 1.0746D-02  6.5267D-05  0.0       0.0     " >> fort.5
   echo " 2358.57     14.324     -0.00226  -0.00024 " >> fort.5 # (cm-1;Her)
#  echo " 2358.5685   14.3244    -0.002258 -0.000235" >> fort.5 # (cm-1;LK)
#             WETE      WESE 
   echo "     0.0       0.0  " >> fort.5 
#----
#   Add = the energy shifting constant for electronic EXCITED states.
